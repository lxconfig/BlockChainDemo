...
from tinymce.models import HTMLField        # 导入富文本模块
...
class GoodsSKU(BaseModel):
    ...
    type = models.ForeignKey("GoodsType", on_delete=models.CASCADE, verbose_name = "商品种类")  # 关联属性，多类
    goods = models.ForeignKey("Goods", on_delete=models.CASCADE, verbose_name = "商品SPU")  # 关联属性，多类
...
class GoodsImage(BaseModel):
    """商品图片模型类"""
    sku = models.ForeignKey("GoodsSKU", verbose_name='商品', on_delete=models.CASCADE)  # 关联属性
